        ...
        <div className={this.props.container && "container"}>
          <div className="row">
            <div
              className={
                this.props.column
                  ? "col-sm-8 col-sm-offset-2 panel panel-default"
                  : "panel panel-default"}>
              <h2 className="title text-center">Cart</h2>
              {view === "checkout" ? null : (
                <a className="clear-cart" onClick={() => handleCartClear()}>
                  Clear Cart</a>)}
              ...
              <div className="text-center cart-totals">
                <h4>
                  <span className="not-bold">{"Items: "}</span>
                  {this.props.cart.length
                    ...
                    : "0"}
                  <span className="not-bold">{" | Total: $"}</span>
                  {cartTotal}
                </h4>
